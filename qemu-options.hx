...
DEF("trans", HAS_ARG, QEMU_OPTION_trans,
    "-trans [file=]path[,startpc=num][,swap=bool]\n"
    "                dump translation of static target code\n"
    "                'file' specify the path of the bin file which contains target raw code\n"
    "                'startpc' is the start pc(in heximal formt) of first instruction, default is 0x0\n"
    "                'swap' indicate if need to swap byte order in word, default is false\n",
    QEMU_ARCH_ALL)
STEXI
@item -trans
@findex -trans
translate static code from a binary file
ETEXI
